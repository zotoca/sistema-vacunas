<section class="container mt-5">
   ...
   <form id="create-news-form" data-aos="fade-up" method="POST" action="{{$news->path()}}"  enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
         <div class="row">
            <div class="col-12">
               ...
               <input type="text" value="{{$news->title}}" class="form-control" name="title" id="title" placeholder="Titulo" autofocus required>
            </div>
      ...
      <div class="form-group">
         <div class="row">
            <div class="col-12">
               <button class="btn btn-success btn-block" type="submit" id="edit-news">
               Editar noticia
