        ...
        <div class="col-md-12 col-lg-4 mb-1">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-1 px-lg-1">
                    <div class="dropdown">
                        <button class="btn btn-primary btn-block dropdown-toggle" type="button" id="houses-filter" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Filtrar
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 px-lg-1">
                    <button class="btn btn-success btn-block" id="create-house">Crear casa <i class="fa fa-plus ml-1"></i></button>
                </div>
            </div>
        </div>
        <div class="col-md-12 col-lg-8 text-center">
            <form class="form-inline text-center mx-auto">
                <div class="input-group w-100">
                    <input type="text" name="number" placeholder="Numero" class="form-control" required />
